...
<footer class="bg-gray-800 py-5 font-sans tracking-wide">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-10 py-8">
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li><a href="/Recommendation" class="text-gray-400 hover:text-white text-base">Recommendation</a></li>
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li><a href="" class="text-gray-400 hover:text-white text-base">Tunis,Ariana,Mnihla</a></li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">achref08fraj@gmail.com</a>
            </li>
            <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">+216 54144380</a></li>
      ...
      <div class="bg-gray-900 p-5 mt-12">
        <p class='text-gray-400 text-base text-center'>Copyright © 2023<a href='https://readymadeui.com/' target='_blank'

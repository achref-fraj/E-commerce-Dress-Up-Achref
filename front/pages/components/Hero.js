            ...
            <div className="sm:max-w-xl text-start">
              ...
              <div className="mt-10 flex flex-col max-sm:items-center max-sm:justify-center">
                ...
                <div className="flex gap-4 items-center max-sm:justify-center max-sm:mt-6">
                  <button className="mt-6 inline-block rounded-md border border-transparent bg-black px-6 py-3 text-center font-medium text-white hover:text-gray-500" onClick={addItemToCart}>
                    Add to cart
                  </button>
                  <Link
  href="/products"

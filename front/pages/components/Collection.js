              ...
              <div className="grid p-6 bg-gray-100 rounded place-content-center sm:p-8">
                <div className="max-w-md mx-auto text-center lg:text-left">
                  <header>
                    ...
                    <p className="mt-1 text-lg text-black">DT. {formatPrice(product.price)}</p>
                  </header>

<Link
  href="/products"
  className="mt-6 inline-block rounded-md bg-black text-white border border-accent px-6 py-3 text-center font-medium hover:bg-gray-400"
>
  Shop All
</Link>
